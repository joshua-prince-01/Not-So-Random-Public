 ...
 */
  ...
  Serial.println("Intial push complete.");
}

void loop() {
  ArduinoCloud.update();
  // Debug: Print cloud variables every 5 seconds
  static uint32_t lastDebug = 0;
  if (millis() - lastDebug >= 5000) {
    lastDebug = millis();
    Serial.print("Cloud vars: enable=");
...
// ===== I2C Update ======
bool sendMotorUpdate(bool en, bool dir, float speed, float motor_run) {
